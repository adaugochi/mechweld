    ...
    return (
        <section className="w-[90%] mx-auto my-20">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                {/* WHO WE ARE */}
                <div className="bg-white rounded-2xl shadow-md p-6 border-t-4 border-[#04359C] hover:shadow-lg transition">
                ...
                {/* STRUCTURE */}
                <div className="bg-white rounded-2xl shadow-md p-6 border-t-4 border-[#F4B400] hover:shadow-lg transition">
